...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2018 at 03:08 AM
...
--
-- Truncate table before insert `admin_fee`
--

TRUNCATE TABLE `admin_fee`;
--
-- Dumping data for table `admin_fee`
--

INSERT INTO `admin_fee` (`id`, `batas_bawah`, `batas_atas`, `fee`) VALUES
(1, 0, 1000000, 10000),
(2, 1000001, 5000000, 20000),
(8, 5000001, 20000000, 40000),
(11, 20000001, 1000000000, 50000);
...
(19, 'LAPORAN', 'Laporan', 'Laporan'),
(20, 'SETTING', 'Setting', 'Setting');

-- --------------------------------------------------------

--
-- Table structure for table `bank_kami`
--

DROP TABLE IF EXISTS `bank_kami`;
CREATE TABLE `bank_kami` (
  `id` int(11) NOT NULL,
...
--
-- Truncate table before insert `bank_kami`
--

TRUNCATE TABLE `bank_kami`;
--
-- Dumping data for table `bank_kami`
--

INSERT INTO `bank_kami` (`id`, `kode_bank`, `norek`, `atas_nama`, `ishapus`) VALUES
(1, '002', '123', 'PT Coba dan Tes 2', 0),
(2, '008', '1234512345', 'Eko Purnomo', 0);
...
(139, 4, 18, 1, 1, 1, 1, 0, 0, 0),
(140, 4, 19, 1, 1, 1, 1, 0, 0, 0),
(141, 1, 20, 1, 1, 1, 1, 0, 0, 0),
...
CREATE TABLE `invoice_detail` (
  `id` int(11) NOT NULL,
  `id_invoice_master` int(11) NOT NULL,
...
--
-- Truncate table before insert `invoice_detail`
--
...
CREATE TABLE `invoice_master` (
  ...
  `status` tinyint(4) NOT NULL COMMENT '0 baru, 1 confirm bayar, 2 terbayar, 3 tertranfer ke penjual 3 ',
  `tgl_bayar_pembeli` date NOT NULL,
  `tgl_transfer_penjual` date NOT NULL,
  `idbank_pembeli` int(11) NOT NULL,
  `bank_norek_pembeli` varchar(32) NOT NULL,
  `bank_atas_nama_pembeli` varchar(64) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Truncate table before insert `invoice_master`
--
...
INSERT INTO `item_produk` (`id_item`, `idkategori`, `id_penjual`, `kode`, `nama`, `deskripsi_singkat`, `deskripsi_full`, `harga`, `status_tampil`, `posting_date`, `ishapus`, `permalink`, `is_premium`) VALUES
(1, 6, 1, 'T01', 'Sosis Ayam Curah per 5kg', 'murah dong', 'ini murah banget', 'RP 120.000 per 5kg', 1, '2018-10-03 09:14:07', 0, 'sosis-ayam-curah-per-5kg--rumah-kopi', 0),
(4, 13, 1, 'B105', 'Brambang Lokal per 5kg', 'brambang murah', 'murah banget, full segudang', '120ribu per 5kg', 1, '2018-10-04 14:30:05', 0, 'brambang-lokal-per-5kg--rumah-kopi', 0),
(5, 4, 7, 'S1234', 'Sosis kemasan ekonomis 2kg', 'sosis kelas B', 'ini kelas B saja, kualitas standar', '40ribu/2kg', 1, '2018-10-04 14:33:52', 1, 'sosis-kemasan-ekonomis-2kg--tepung-mania', 0),
(6, 12, 7, 'B13', 'Tepung Beras kemasan 5kg', 'tepung grade B', 'rada-rada gimana gitu rasanya', '60 ribu / 5kg', 1, '2018-10-05 10:26:27', 0, 'tepung-beras-kemasan-5kg--tepung-mania', 0),
(7, 1, 1, 'BB', 'tes 3', 'coba aja', '<p>ini coba aja</p><p><img src=\"http://localhost/restodepo2/assets/gambar_editor/1539233422_small.jpg\" style=\"width: 400px;\"></p><p><br></p><p><img src=\"http://localhost/restodepo2/assets/gambar_editor/1539233431_small.jpg\" style=\"width: 400px;\"></p><p><br></p><p><img src=\"http://localhost/restodepo2/assets/gambar_editor/1539233449.jpg\" style=\"width: 225px;\"></p><p><br></p><p>ini edit</p><p><img src=\"http://localhost/restodepo2/assets/gambar_editor/1539246525.jpg\" style=\"width: 243px;\"><br></p>', '120ribu per 5kg', 1, '2018-10-11 11:51:35', 0, 'tes-3--rumah-kopi', 0),
(8, 1, 1, 'cc', 'cc cc', 'fwefwe wfwefwe', '<p>apa ini</p><p><img src=\"http://localhost/restodepo2/assets/gambar_editor/1539234049.jpg\" style=\"width: 225px;\"></p><p><br></p><p>&lt;script type=\"text/javascript\"&gt;</p><p>alert(\'tess\');</p><p>&lt;/script&gt;</p>', '120ribu per 5kg', 1, '2018-10-11 12:01:35', 0, 'cc-cc--rumah-kopi', 0);

-- --------------------------------------------------------

--
-- Table structure for table `item_produk_foto`
--

DROP TABLE IF EXISTS `item_produk_foto`;
CREATE TABLE `item_produk_foto` (
  `id_foto` int(11) NOT NULL,
  `id_item` int(11) NOT NULL,
  `id_penjual` int(11) NOT NULL,
  `file_foto` text NOT NULL,
  `ishapus` tinyint(1) NOT NULL COMMENT '0: belum terhapus, 1: sudah terhapus',
...
--
-- Truncate table before insert `item_produk_foto`
--

TRUNCATE TABLE `item_produk_foto`;
--
-- Dumping data for table `item_produk_foto`
--

INSERT INTO `item_produk_foto` (`id_foto`, `id_item`, `id_penjual`, `file_foto`, `ishapus`, `posting_date`, `thumbnail`, `caption`, `img_width`, `img_height`) VALUES
(1, 3, 1, '20181004092248_9394.jpg', 0, '2018-10-04 07:22:52', '20181004092248_9394_small.jpg', NULL, 225, 225),
(5, 6, 7, '20181005052617_3342.jpg', 0, '2018-10-05 03:26:28', '20181005052617_3342_small.jpg', NULL, 225, 225),
(6, 6, 7, '20181005052626_2529.jpg', 0, '2018-10-05 03:26:28', '20181005052626_2529_small.jpg', NULL, 191, 263),
(18, 5, 7, '20181004093328_2415.jpg', 0, '2018-10-05 06:50:23', '20181004093328_2415_small.jpg', NULL, 225, 225),
(19, 5, 7, '20181004093348_3824.jpg', 0, '2018-10-05 06:50:23', '20181004093348_3824_small.jpg', NULL, 225, 225),
(20, 5, 7, '20181005083330_8386.jpg', 0, '2018-10-05 06:50:24', '20181005083330_8386_small.jpg', NULL, 1600, 898),
(21, 4, 1, '20181004092248_9394.jpg', 0, '2018-10-10 01:41:01', '20181004092248_9394_small.jpg', NULL, 225, 225),
(23, 8, 1, '20181011070133_9792.jpg', 0, '2018-10-11 05:01:35', '20181011070133_9792_small.jpg', NULL, 225, 225),
(24, 7, 1, '20181011065134_4854.jpg', 0, '2018-10-11 08:28:50', '20181011065134_4854_small.jpg', NULL, 225, 225);
...
DROP TABLE IF EXISTS `tanya_jawab`;
CREATE TABLE `tanya_jawab` (
  ...
  `id_root` int(11) NOT NULL COMMENT '0: root, selain 0:idtj rootnya',
  `posting_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `poster` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1 pembeli, 2 penjual'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Truncate table before insert `tanya_jawab`
--

TRUNCATE TABLE `tanya_jawab`;
--
-- Dumping data for table `tanya_jawab`
--

INSERT INTO `tanya_jawab` (`idtj`, `id_pembeli`, `id_penjual`, `id_item`, `konten`, `id_root`, `posting_date`, `poster`) VALUES
(1, 4, 1, 4, 'apakah bisa kirim kesini?', 0, '2018-10-17 08:57:19', 1),
(2, 3, 1, 1, 'tanya dulu dong ', 0, '2018-10-17 08:59:02', 1),
(3, 4, 1, 4, 'kesini itu kemana? sebutin kotanya', 1, '2018-10-17 08:58:50', 2),
(4, 4, 1, 4, 'dikirim ke rumah saya, masak ndak tau', 1, '2018-10-17 08:59:19', 1),
(5, 4, 1, 4, 'Rumah kamu di kota mana?', 1, '2018-10-17 10:14:31', 2);
...
(74, 1, 'superadmin', '2018-10-04 09:42:22', 'Login ke dashboard'),
(75, 1, 'superadmin', '2018-10-04 10:12:00', 'Tambah item produk: Sosis Ayam Curah per 5kg'),
(76, 1, 'superadmin', '2018-10-04 14:05:03', 'Login ke dashboard'),
(77, 1, 'superadmin', '2018-10-04 14:22:52', 'Tambah item produk: Brambang Lokal per 5kg'),
(78, 1, 'superadmin', '2018-10-04 14:30:05', 'Tambah item produk: Brambang Lokal per 5kg'),
(79, 1, 'superadmin', '2018-10-04 14:33:52', 'Tambah item produk: Sosis sapi kemasan 2kg'),
(80, 1, 'superadmin', '2018-10-05 08:25:54', 'Login ke dashboard'),
(81, 1, 'superadmin', '2018-10-05 10:26:28', 'Tambah item produk: Tepung Beras kemasan 5kg'),
(82, 1, 'superadmin', '2018-10-05 12:58:15', 'Login ke dashboard'),
(83, 1, 'superadmin', '2018-10-05 13:31:09', 'Edit item produk: Sosis sapi kemasan 2kg'),
(84, 1, 'superadmin', '2018-10-05 13:33:35', 'Edit item produk: Sosis sapi kemasan 2kg'),
(85, 1, 'superadmin', '2018-10-05 13:48:05', 'Edit item produk: Sosis sapi kemasan 2kg'),
(86, 1, 'superadmin', '2018-10-05 13:50:03', 'Edit item produk: Sosis sapi kemasan ekonomis 2kg'),
(87, 1, 'superadmin', '2018-10-05 13:50:24', 'Edit item produk: Sosis kemasan ekonomis 2kg'),
(88, 1, 'superadmin', '2018-10-05 13:50:57', 'Menghapus item produk: Sosis kemasan ekonomis 2kg'),
(89, 1, 'superadmin', '2018-10-10 08:40:41', 'Login ke dashboard'),
(90, 1, 'superadmin', '2018-10-10 08:41:01', 'Edit item produk: Brambang Lokal per 5kg'),
(91, 1, 'superadmin', '2018-10-10 10:31:05', 'Login ke dashboard'),
(92, 1, 'superadmin', '2018-10-11 10:08:42', 'Login ke dashboard'),
(93, 1, 'superadmin', '2018-10-11 11:50:02', 'Login ke dashboard'),
(94, 1, 'superadmin', '2018-10-11 11:51:37', 'Tambah item produk: tes 3'),
(95, 1, 'superadmin', '2018-10-11 12:01:35', 'Tambah item produk: cc cc'),
(96, 1, 'superadmin', '2018-10-11 15:27:42', 'Login ke dashboard'),
(97, 1, 'superadmin', '2018-10-11 15:28:50', 'Edit item produk: tes 3'),
(98, 1, 'superadmin', '2018-10-17 08:26:08', 'Login ke dashboard'),
(99, 1, 'superadmin', '2018-10-17 09:46:01', 'Logout dari dashboard'),
(100, 1, 'superadmin', '2018-10-17 09:46:52', 'Login ke dashboard'),
(101, 1, 'superadmin', '2018-10-18 10:17:29', 'Login ke dashboard'),
(102, 1, 'superadmin', '2018-10-18 10:26:26', 'Logout dari dashboard'),
(103, 1, 'superadmin', '2018-10-18 10:36:47', 'Login ke dashboard'),
(104, 1, 'superadmin', '2018-10-18 11:21:52', 'Tambah bank restodepo: 1122334455 atas nama: PT Coba dan Tes'),
(105, 1, 'superadmin', '2018-10-18 11:23:07', 'Tambah bank restodepo: 1234512345 atas nama: Eko Purnomo'),
(106, 1, 'superadmin', '2018-10-18 14:03:49', 'Login ke dashboard'),
(107, 1, 'superadmin', '2018-10-18 14:16:20', 'Menghapus bank: 1122334455 atas nama: PT Coba dan Tes'),
(108, 1, 'superadmin', '2018-10-18 14:27:40', 'Edit bank kami: 123 atas nama: PT Coba dan Tes 2'),
(109, 1, 'superadmin', '2018-10-19 08:30:58', 'Login ke dashboard'),
(110, 1, 'superadmin', '2018-10-19 13:17:51', 'Login ke dashboard'),
(111, 1, 'superadmin', '2018-10-19 14:07:16', 'Tambah fee transaksi 0 - 1000000, Fee: 12000'),
(112, 1, 'superadmin', '2018-10-19 14:15:09', 'Tambah fee transaksi 1000001 - 5000000, Fee: 20000'),
(113, 1, 'superadmin', '2018-10-19 14:19:59', 'Tambah fee transaksi 1 - 2, Fee: 3'),
(114, 1, 'superadmin', '2018-10-19 14:22:39', 'Menghapus admin fee id: 3, nilai fee: 3'),
(115, 1, 'superadmin', '2018-10-19 14:26:32', 'Tambah fee transaksi 4 - 5, Fee: 6'),
(116, 1, 'superadmin', '2018-10-19 14:27:17', 'Tambah fee transaksi 3 - 4, Fee: 5'),
(117, 1, 'superadmin', '2018-10-19 14:30:48', 'Menghapus admin fee id: 5, nilai fee: 5'),
(118, 1, 'superadmin', '2018-10-19 14:30:51', 'Menghapus admin fee id: 4, nilai fee: 6'),
(119, 1, 'superadmin', '2018-10-19 14:31:41', 'Tambah fee transaksi 5 - 5, Fee: 5'),
(120, 1, 'superadmin', '2018-10-19 14:32:04', 'Tambah fee transaksi 8 - 8, Fee: 8'),
(121, 1, 'superadmin', '2018-10-19 14:37:12', 'Tambah fee transaksi 23 - 26, Fee: 28'),
(122, 1, 'superadmin', '2018-10-19 14:37:25', 'Menghapus admin fee id: 7, nilai fee: 8'),
(123, 1, 'superadmin', '2018-10-19 14:37:35', 'Tambah fee transaksi 230 - 261, Fee: 282'),
(124, 1, 'superadmin', '2018-10-19 14:37:47', 'Menghapus admin fee id: 6, nilai fee: 282'),
(125, 1, 'superadmin', '2018-10-19 14:38:17', 'Tambah fee transaksi 5000001 - 20000000, Fee: 40000'),
(126, 1, 'superadmin', '2018-10-19 14:39:32', 'Tambah fee transaksi 12 - 13, Fee: 14'),
(127, 1, 'superadmin', '2018-10-19 14:39:40', 'Menghapus admin fee id: 9, nilai fee: 14'),
(128, 1, 'superadmin', '2018-10-19 14:39:59', 'Tambah fee transaksi 20000001 - 1000000000, Fee: 50000'),
(129, 1, 'superadmin', '2018-10-19 14:40:10', 'Menghapus admin fee id: 10, nilai fee: 50000'),
(130, 1, 'superadmin', '2018-10-19 14:40:33', 'Tambah fee transaksi 20000001 - 1000000000, Fee: 50000'),
(131, 1, 'superadmin', '2018-10-19 14:40:46', 'Tambah fee transaksi 0 - 1000000, Fee: 10000'),
(132, 1, 'superadmin', '2018-10-22 08:04:41', 'Login ke dashboard');
...
(94, 1, 19, 1, 1, 1, 1, 0, 0, 0),
(95, 8, 18, 1, 1, 1, 1, 0, 0, 0),
(96, 8, 19, 1, 1, 1, 1, 0, 0, 0),
(97, 1, 20, 1, 1, 1, 1, 0, 0, 0),
(98, 8, 20, 1, 1, 1, 1, 0, 0, 0);
...
--
-- Indexes for table `admin_fee`
--
ALTER TABLE `admin_fee`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `bank_kami`
--
ALTER TABLE `bank_kami`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `invoice_master`
  ADD PRIMARY KEY (`id_invoice_master`) USING BTREE;
...
--
-- Indexes for table `item_produk_foto`
--
ALTER TABLE `item_produk_foto`
...
--
-- AUTO_INCREMENT for table `admin_fee`
--
ALTER TABLE `admin_fee`
...
--
-- AUTO_INCREMENT for table `bank_kami`
--
ALTER TABLE `bank_kami`
...
--
ALTER TABLE `invoice_master`
  MODIFY `id_invoice_master` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `item_produk_foto`
--
ALTER TABLE `item_produk_foto`
...
--
ALTER TABLE `tanya_jawab`
  MODIFY `idtj` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
