...
<div id="dashboard">
	<div class="container-fluid">
		<div class="row">
			<div class="menu-dashboard col-md-3 col-lg-3 col-xl-2">
					<?php
						include "menu-dashboard-penjual.php";
					?>			
			</div>
			<div class="konten-dashboard col-md-9 col-lg-9 col-xl-10">
								...
								<div class="isi-pesan" >
									<div class="container">
										<div class="ketik-pesan" align="right">
											<div class="row">
												<div class="col-8 col-sm-9 col-md-8 col-lg-9 text" align="right">
										...
										<div class="balasan-pesan" align="left">
											<div class="row">
												<div class="col-4 col-sm-3 col-md-4 col-lg-3 " align="left">
													<img src="assets/avatar_pembeli/foto/p3.png">		
												</div>
												<div class="col-8 col-sm-9 col-md-8 col-lg-9 text">
									...
									<div class="container">
										<div class="row">
											<div class="col-10 col-sm-10 col-md-10 col-lg-10 col-xl-10 ">
												<div class="input-group">
													<span class="input-group-addon" id="sizing-addon2">
														<div class="buat-invoice" style="padding-top: 15px; color: #FA7422; ">
															<a>Buat Invoice</a>
														</div>											
													</span>
													<textarea class="form-control" id="exampleFormControlTextarea1" rows="1" placeholder="Ketik Pesan...."  aria-describedby="sizing-addon2" value></textarea>								  	
												</div>
											</div>
