  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      	<div class="row" style="margin-top:-25px;">
            <div class="col-md-6"><h3>Edit Item</h3></div>
    ...
    <section class="content container-fluid" style="margin-top:-10px;">
		<div class="box">
        	<div class="box-body">
           		<form name="dasarform" id="dasarform" method="post" action="<?php echo base_url(); ?>backend/toko/do_edit_item">
                                ...
                                <div class="form-group">
                                  <label for="idkategoriparent">Kategori</label>
                                  <select name="idkategoriparent" id="idkategoriparent" class="form-control" onchange="ganti_parent_kategori_edit()">
                                  
                                  <?php
                                    foreach ($list_kategori as $entry)
                                    {
                                            if($entry['idkategori'] == $parent_kategori){
                                            echo "<option value=\"".$entry['idkategori']."\" selected>".$entry['nama']."</option>";  
                                        }else{
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kode" name="kode" placeholder="A001" value="<?php echo $deitem['kode'];?>">
                                </div>

                                <div class="form-group">
                                    <label for="nama">Nama Item</label>
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="nama item" value="<?php echo $deitem['nama'];?>" required>
                                </div>

                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi </label>
                                    <textarea name="deskripsi" class="form-control" id="deskripsi" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $deitem['deskripsi'];?></textarea>
                                </div> 

                                <div class="form-group">
                                    <label for="harga">Harga</label>
                                    <input type="number" class="form-control" id="harga" name="harga" value="<?php echo $deitem['harga'];?>" step="100">
                                </div>

                                <div class="form-group">
                                    <label for="diskon_persen">Diskon, dalam persen</label>
                                    <input type="number" class="form-control" id="diskon_persen" name="diskon_persen" value="<?php echo $deitem['diskon_persen'];?>" step="1" min="0" max="100">
                                </div>

                                <div class="form-group">
                                    <label for="stok">Jumlah Stok</label>
                                    <input type="number" class="form-control" id="stok" name="stok" value="<?php echo $deitem['stok'];?>" step="1" min="0">
                                </div>

                                <div class="form-group">
                                    <label for="berat">Berat dalam kilogram</label>
                                    <input type="number" class="form-control" id="berat" name="berat" value="<?php echo $deitem['berat'];?>" step="0.1" min="0">
                                </div>

                                <div class="form-group">
                                    <label for="rasa">Rasa, jika ada</label>
                                    <input type="text" class="form-control" id="rasa" name="rasa" value="<?php echo $deitem['rasa'];?>">
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <select name="status_tampil" id="status_tampil" class="form-control" >
                                    <option value="1" <?php if ($deitem['status_tampil'] == 1) {
    echo " selected=\"selected\"";
} ?>>Tampil</option>
                                        <option value="0" <?php if ($deitem['status_tampil'] == 0) {
    echo " selected=\"selected\"";
} ?>>Tidak Tampil</option>
                                  </select>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <select name="status_hapus" id="status_hapus" class="form-control" >
                                    <option value="1" <?php if ($deitem['ishapus'] == 1) {
    echo " selected=\"selected\"";
} ?>>Terhapus</option>
                                        <option value="0" <?php if ($deitem['ishapus'] == 0) {
    echo " selected=\"selected\"";
} ?>>Tidak Terhapus</option>
                                  </select>
                                </div>

                                <div class="form-group">
                                  <label>Tambah Foto Item</label> <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="id_item" id="id_item" type="hidden" value="<?php echo $id_item; ?>" />
...
function ganti_parent_kategori_edit()
{
    var idparent = $('#idkategoriparent').val();
    $.ajax({
            url: "<?php echo base_url() ?>backend/toko/get_child_kategori_edit",
            type: "POST",
            data: {idparent:idparent, idkategori:<?php echo $deitem['idkategori'];?>}
            })
