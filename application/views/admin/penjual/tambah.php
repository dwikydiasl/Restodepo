  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      	<div class="row" style="margin-top:-25px;">
            <div class="col-md-6"><h3>Tambah Penjual</h3></div>
    ...
    <section class="content container-fluid" style="margin-top:-10px;">
		<div class="box">
        	<div class="box-body">
           		<form name="dasarform" id="dasarform" method="post" action="<?php echo base_url(); ?>backend/penjual/do_tambah_penjual">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" class="form-control" id="deskripsi" style="width: 100%; height: 60px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat" class="form-control" id="alamat" placeholder="Example: Jl. Boulevard Kelapa Gading Blok M" required>
                                    <div id="map-canvas" style="height:250px;width:100%;margin-top:20px;"></div>
                                </div>
                                
                                <div class="form-group">
                                  <label for="the_lat">Latitude</label>
                                  <input type="text" class="form-control" id="the_lat" name="the_lat" required>
                                </div>

                                <div class="form-group">
                                  <label for="the_long">Longitude</label>
                                  <input type="text" class="form-control" id="the_long" name="the_long" required>
                                </div>
