...
<html>
    ...
    <body>
        <form name="dasarform_ekko" id="dasarform_ekko" method="post" action="<?php echo base_url(); ?>backend/setting/do_edit_admin_fee">


                <div class="form-group">
                  <label for="batas_bawah">Batas Bawah Transaksi</label>
                  <input type="number" class="form-control" id="batas_bawah" name="batas_bawah" value="<?php echo $detail['batas_bawah'];?>" required="">
                </div>
                <div class="form-group">
                  <label for="batas_atas">Batas Atas Transaksi</label>
                  <input type="number" class="form-control" id="batas_atas" name="batas_atas" value="<?php echo $detail['batas_atas'];?>" required>
                </div>

                <div class="form-group">
                  <label for="fee">Admin Fee</label>
                  <input type="number" class="form-control" id="fee" name="fee" value="<?php echo $detail['fee'];?>" required>
                </div>
