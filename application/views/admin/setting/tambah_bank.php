  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      	<div class="row" style="margin-top:-25px;">
            <div class="col-md-6"><h3>Tambah Bank</h3></div>
    ...
    <section class="content container-fluid" style="margin-top:-10px;">
		<div class="box">
        	<div class="box-body">
           		<form name="dasarform" id="dasarform" method="post" action="<?php echo base_url(); ?>backend/setting/do_tambah_bank">
               <div class="form-group">
                  ...
                  <?php
                    foreach ($list_bank as $entry)
                    {
                      ...
                      echo "<option value=\"".$entry['kode']."\">".$entry['nama']." (".$entry['kode'].")</option>";
