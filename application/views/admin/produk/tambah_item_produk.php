        	...
        	<div class="box-body">
           		<form name="dasarform" id="dasarform" method="post" action="<?php echo base_url(); ?>backend/produk/do_tambah_item_produk">
                                <div class="form-group">
                                  ...
                                  <?php
                                    foreach ($list_penjual as $entry)
                                    {
                                        ...
                                        echo "<option value=\"".$entry['id']."\">".$entry['nama']."</option>";
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi_singkat" class="form-control" id="deskripsi_singkat"></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="deskripsi_full">Deskripsi Full</label>
                                    <textarea name="deskripsi_full" class="form-control" id="summernote"></textarea>
                                </div> 
                                  ...
                                  <div class="panel-body">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col col-md-4" >
                                            <label><input name="cekdata[]" type="checkbox" value="<?php echo $rowx['id']; ?>_yes" /> <?php echo $rowx['nama']?></label>
                                        </div>
                                        <?php } ?>
                                    </div>
                                  </div>
