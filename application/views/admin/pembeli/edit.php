  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      	<div class="row" style="margin-top:-25px;">
            <div class="col-md-6"><h3>Edit Pembeli</h3></div>
    ...
    <section class="content container-fluid" style="margin-top:-10px;">
		<div class="box">
        	<div class="box-body">
           		<form name="dasarform" id="dasarform" method="post" action="<?php echo base_url(); ?>backend/pembeli/do_edit_pembeli">
                                ...
                                <div class="form-group">
                                  <label for="password1">Password (kosongkan jika tidak ingin mengganti password)</label>
                                  ...
                                  <button type="button" class="btn btn-primary" onClick="mulai_upload();" name="btnuploader" id="btnuploader"><i class='fa fa-image'></i> Browse</button>
                                    <div id="preview_gambar" style="margin-bottom:20px; margin-top:10px;">
                                        <?php
                                            ...
                                            {
                                        ?>
                                        <img src="<?php echo base_url().'assets/avatar_pembeli/thumbnail/'.$detail['avatar'];?>" height='100'>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="daftarfilelogo_thumb" id="daftarfilelogo_thumb" value="<?php echo $detail['avatar'];?>">
                                    <input type="hidden" name="id" id="id" value="<?php echo $detail['id_pembeli'];?>">
